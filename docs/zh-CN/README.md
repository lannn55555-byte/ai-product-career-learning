...
课程资料会区分稳定原理、当前平台行为、岗位证据和用户自身证据。涉及模型能力、API、价格、政策等易变信息时，会优先核对官方当前文档；来源选择与核验规则见[学习证据与来源规则](../../skills/adaptive-ai-learning-coach/references/learning-evidence-and-source-policy.md)。
